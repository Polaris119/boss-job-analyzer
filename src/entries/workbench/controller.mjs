...
import { deleteTask, getAllTasks, getTask, putTask, subscribeToTaskChanges } from "../../platform/indexeddb/task-repository.mjs";
...
const elements = Object.fromEntries(["concurrency","toggle-queue","clear-history","stat-total","stat-queued","stat-running","stat-completed","stat-failed","runner-status","task-list","empty","toast"].map((id) => [id, document.getElementById(id)]));
